...
"}")
        ...
        self.detect_window.setStyleSheet("QLabel { background-color : black; color : lightseagreen ; font-family: 'Calibri'; }")
...
"")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("picture/button/pngaaa.com-828917.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("picture/button/camera-131965017355314519_32.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
